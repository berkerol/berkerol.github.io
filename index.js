const projects = [['fireworks', true, 'Fireworks', 'Create your own fireworks show or watch one randomly'], ['stargazing', true, 'Stargazing', 'A beautiful sky animation with colorful and moving stars'], ['coronavirus-simulator', true, 'Coronavirus Simulator', 'Watch how coronavirus (COVID-19) spreads'], ['party', true, 'Party', 'Join this party with colorful confetti'], ['snowstorm', true, 'Snowstorm', 'Watch a crazy snowstorm in the comfort of your browser'], ['meteors', true, 'Meteors', 'Watch a meteor shower whenever you want'], ['spaceflight', true, 'Spaceflight', 'Enter a journey into the depths of space'], ['aggregator', true, 'Aggregator', 'A beautiful aggregator animation with colorful particles'], ['hypnotizer', true, 'Hypnotizer', 'Hypnotize yourself with the flowing characters'], ['stock-price-simulator', true, 'Stock Price Simulator', 'Generate a random stock chart or watch its progress'], ['random-binary-music', true, 'Random Binary Music', 'Listen to the music of random binary numbers'], ['sprinter-turtle', true, 'Sprinter Turtle', '2D top down road crossing game'], ['battle-pong', true, 'Battle Pong', 'Remake of the classic game with rockets and different game types'], ['breakout', true, 'Breakout', 'Remake of the classic game with meteors'], ['typer', true, 'Typer', 'A tower defense like typing game'], ['rhythmic-typer', true, 'Rhythmic Typer', 'A rhythm-based typing game'], ['beat-the-market', true, 'Beat the Market', 'Buy low, sell high, make money'], ['guess-the-image', true, 'Guess the Image', 'Try to recognize the partially visible images'], ['guess-the-number', true, 'Guess the Number', 'Try to find the number using various hints'], ['match-the-numbers', true, 'Match the Numbers', 'Try to make all numbers equal by visiting them'], ['guess-the-song', true, 'Guess the Song', 'Try to guess the song you hear'], ['hangman', true, 'Hangman', 'Remake of the classic game with GUI'], ['guess-the-average', true, 'Guess the Average', 'Try to calculate the average of the appearing numbers'], ['rock-paper-scissors-lizard-spock', true, 'Rock Paper Scissors Lizard Spock', 'Remake of the classic game with the Lizard Spock expansion'], ['roll-a-ball', true, 'Roll a Ball', 'Destroy the cubes without touching the walls'], ['guess-where', true, 'Guess Where', 'Try to guess the location of random photo'], ['battleshipjs', true, 'Battleship.js', 'A Battleship CLI game with customizations'], ['lottery', true, 'Lottery', 'Decentralized autonomous lottery'], ['flight-tracker', true, 'Flight Tracker', 'List all real-time flights in an area'], ['github-explorer', true, 'GitHub Explorer', 'Filter and sort all repositories of a user or organization'], ['affine-cipher', true, 'Affine Cipher', 'Simple & easy-to-use Affine Cipher GUI'], ['empatica-charts', true, 'Empatica Charts', 'Charts for physiological data gathered from <a href="https://www.empatica.com/research/e4">Empatica E4</a> wristband'], ['photo-of-the-day', false, 'Photo of the Day', 'Downloads Bing, NASA, National Geographic, Unsplash Photo of the Day and sets it as wallpaper'], ['mousejs', false, 'Mouse.js', 'Move your mouse with arrow keys on the keyboard'], ['libraries', false, 'Libraries', 'Libraries for common functionalities of my other repositories'], ['cv', false, 'CV', 'My CV']];
